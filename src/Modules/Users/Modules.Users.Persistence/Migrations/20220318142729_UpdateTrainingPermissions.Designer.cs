...
namespace Modules.Users.Persistence.Migrations
{
    ...
    [Migration("20220318142729_UpdateTrainingPermissions")]
    partial class UpdateTrainingPermissions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Users.Domain.Roles.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 200,
                            Description = "Can read invitations.",
                            Name = "ReadInvitations"
                        },
                        new
                        {
                            Id = 201,
                            Description = "Can cancel invitation.",
            ...
            modelBuilder.Entity("Modules.Users.Domain.UserRegistrations.UserRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Email", "Status")
                        .HasDatabaseName("ix_user_registrations_email_status");

                    b.ToTable("user_registrations", "users");
                });
